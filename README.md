...
Official .NET SDK for Kavenio social posting and scheduling.

## Installation

```bash
dotnet add package Kavenio.Sdk
```

## Get an API key

Create a Kavenio account from the [dashboard](https://app.kavenio.com), then create an API key from [API Keys](https://app.kavenio.com/api-keys).
...
The generated SDK source lives in [generated/dotnet](generated/dotnet).
...
- [SDK docs](https://kavenio.com/docs/sdk/dotnet)
