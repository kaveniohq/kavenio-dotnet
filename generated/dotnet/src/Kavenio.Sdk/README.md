...
inputSpec: openapi/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{7B6520BA-52D8-432A-A0E1-9A605924A282}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            ICheckAccountHealthApiResponse apiResponse = await api.CheckAccountHealthAsync("todo");
            CheckAccountHealth200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Kavenio Social Posting SDK API
- appVersion: 1.0.0
- appDescription: Generated OpenAPI document for Kavenio SDKs that support social posting, media, account connection, validation, and scheduling workflows.
